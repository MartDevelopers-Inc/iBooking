    ...
    <main class="flex-shrink-0">
        ...
        <div class="container">
            ...
            <footer class="footer mt-auto py-3">
                <div class="row">
                    <div class="col">
                        <a href="sign_up?user=Host" class="btn btn-block btn-info btn-lg">Join As Host</a>
                    </div>
                    <div class="col">
                        <a href="sign_up?user=User" class="btn btn-block btn-danger btn-lg">Join As User </a>
                    </div>
                </div>
            </footer>
        </div>
