...
if (isset($_POST['add_file'])) {
    ...
    $file_host_service_id  = $_GET['view'];

    /* Upload File */
    $file_data = $file_host_service_id . $_FILES['file_data']['name'];
    $upload_directory = "../public/services/" . $file_data;
    $temp_name = $_FILES["file_data"]["tmp_name"];
    move_uploaded_file($temp_name, $upload_directory);

    /* Prepare */
    $sql = "INSERT INTO host_service_files (file_id, file_type, file_data, file_host_service_id) VALUES(?,?,?,?)";
                        ...
                        <div class="row">
                            <div class="col">
                                <h6 class="text-dark my-1">
                                    ...
                                    <span class="text-center vm ml-2">Add <?php echo $service->service_name; ?> Files</span>
                                </h6>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row px-2">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-12 col-md-6 text-right">
                                    <input type="submit" name="add_file" value="Submit" class="btn btn-sm btn-primary">
                                </div>
                            </form>
                        </div>
                    </div>
