...
<body class="body-scroll d-flex flex-column h-100 menu-overlay">
    ...
    <div class="flex-shrink-0">
        ...
        $view  = $_GET['view'];
        $ret = "SELECT * FROM  booking WHERE booking_id ='$view'";
                        ...
                        <div class="row">
                            <div class="col">
                                <h6 class="text-dark my-1">
                                    ...
                                    <span class="text-center vm ml-2">Update Booking</span>
                                </h6>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row mt-">
                                    <div class="col-6 col-md-6">
                                        <div class="form-group floating-form-group">
                                            <input type="date" value="<?php echo $booking->booking_date; ?>" name="booking_date" class="form-control floating-input">
                                            <label class="floating-label">Date</label>
                                        </div>
                                    </div>
                                    <div class="col-6 col-md-6">
                                        <div class="form-group floating-form-group">
                                            <input type="time" value="<?php echo $booking->booking_time; ?>" name="booking_time" class="form-control floating-input">
                                            <label class="floating-label">Time</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-group floating-form-group">
                                            <input type="date" value="<?php echo $booking->booking_requested_start_date; ?>" name="booking_requested_start_date" class="form-control floating-input">
                                            <label class="floating-label">Requested Start Date</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-group floating-form-group">
                                            <input type="time" value="<?php echo $booking->booking_requested_start_time; ?>" name="booking_requested_start_time" class="form-control floating-input">
                                            <label class="floating-label">Requested Start Time</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-group floating-form-group">
                                            <input type="date" value="<?php echo $booking->booking_requested_end_date; ?>" name="booking_requested_end_date" class="form-control floating-input">
                                            <label class="floating-label">Requested End Date</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-group floating-form-group">
                                            <input type="time" value="<?php echo $booking->booking_requested_end_time; ?>" name="booking_requested_end_time" class="form-control floating-input">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group floating-form-group">
                                            <textarea type="text" rows="4" name="booking_description" class="form-control floating-input"><?php echo $booking->booking_description; ?></textarea>
                                            <label class="floating-label">Description</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 text-right">
                                    <input type="submit" name="update_booking" value="Submit" class="btn btn-sm btn-primary">
                                </div>
                            </form>
                        </div>
                    </div>
