            ...
            <div class="modal-dialog modal-dialog-sm modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Register User</h5>
                    ...
                    <div class="modal-body">
                        <form method="POST">
                            <div class="row mt-">
                                <div class="col-12 col-md-6">
                                    <div class="form-group floating-form-group">
                                        <input type="text" name="user_name" class="form-control floating-input">
                                        <label class="floating-label">Full Name</label>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group floating-form-group">
                                        <input type="text" name="user_mobile" class="form-control floating-input">
                                        <label class="floating-label">Contacts</label>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group floating-form-group">
                                        <input type="email" name="user_email" class="form-control floating-input">
                            ...
                            <div class="col-12 col-md-6 text-right">
                                <input type="submit" name="add_user" value="Submit" class="btn btn-sm btn-primary">
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <h6 class="text-dark my-1">
                                ...
                                <span class="text-center vm ml-2">Registered Users</span>
                            </h6>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="card-body d-flex align-items-center">
                                        <div class="card-content">
                                            <p class="mb-3 sm">
                                                ...
                                                Mobile: <?php echo $users->user_mobile; ?> <br>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="card-footer text-right mb-3 sm">
                                        <a href="user?view=<?php echo $users->user_id; ?>" class="badge  badge-pill badge-warning">
                                            Update
                                        </a>
                                        <a href="users?delete=<?php echo $users->user_id; ?>" class="badge badge-pill badge-danger">
                                            Delete
                                        </a>
                                    </div>
                                </div>
