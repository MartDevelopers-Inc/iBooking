...
if (isset($_POST['update_personal_info'])) {
    ...
    /* Persist */
    $sql = "UPDATE user SET  user_name =?, user_mobile =?, user_email =? WHERE user_id =?";
...
if (isset($_POST['update_login'])) {
    ...
    $sql = "SELECT * FROM login WHERE login_user_id = '$login_user_id'";
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        if ($old_password != $row['login_password']) {
            ...
            $query = "UPDATE login SET  login_password =?, login_email =? WHERE login_user_id =?";
            $stmt = $mysqli->prepare($query);
            $rc = $stmt->bind_param('sss', $new_password, $login_email, $login_user_id);
            $stmt->execute();
            if ($stmt) {
            ...
            <header class="header">
                <div class="row">
                    <div class="col-auto px-0">
                        <a href="user_home" class="btn menu-btn btn-link text-dark">
                            ...
                            <div class="row mt-">
                                <div class="col-12 col-md-6">
                                    <div class="form-group floating-form-group">
                                        <input type="text" name="user_name" class="form-control floating-input" value="<?php echo $user->user_name; ?>">
                                        <label class="floating-label">Full Name</label>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group floating-form-group">
                                        <input type="text" name="user_mobile" class="form-control floating-input" value="<?php echo $user->user_mobile; ?>">
                                        <label class="floating-label">Contacts</label>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group floating-form-group">
                                        <input type="email" name="user_email" class="form-control floating-input" value="<?php echo $user->user_email; ?>">
