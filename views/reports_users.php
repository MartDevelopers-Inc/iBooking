                    ...
                    <div class="row">
                        <div class="col">
                            <h6 class="text-dark my-1 text-center">
                                ...
                                <span class="text-center vm ml-2">Users Reports </span>
                            </h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <table id="report" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $services->user_name; ?></td>
                                    <td><?php echo $services->user_mobile; ?></td>
                                    <td><?php echo $services->user_email; ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
