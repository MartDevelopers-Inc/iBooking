                            ...
                            <div class="col-12 px-2">
                                <div class="card card-round border border-success text-dark">
                                    ...
                                    <div class="card-footer text-center mb-3 sm">
                                        <a href="host_service_host_file?view=<?php echo $services->host_service_id; ?>" class="badge  badge-pill badge-primary">
                                            Upload Images
                                        </a>
                                        <a href="host_service_host?view=<?php echo $services->host_service_id; ?>" class="badge  badge-pill badge-warning">
                                            Update
                                        </a>
                                        <a href="host_services_host?delete=<?php echo $services->host_service_id; ?>" class="badge badge-pill badge-danger">
                                            Delete
                                        </a>
                                    </div>
                                </div>
