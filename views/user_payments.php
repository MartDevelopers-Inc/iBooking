...
if (isset($_GET['delete'])) {
    ...
    /* Persist */
    $sql = "DELETE FROM payment WHERE payment_id  = '$delete'";
                    ...
                    <div class="row">
                        <div class="col">
                            <h6 class="text-dark my-1">
                                <span class="text-center vm ml-2">Bookings Payments Details</span>
                            </h6>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card card-round border border-success text-dark">
                                    <div class="card-body">
                                        <div class="card-content">
                                            <p class="text-center text-primary">Payment Details</p>
                                            <p class="mb-3 sm">
                                                ...
                                                Mode: <?php echo $services->payment_mode; ?> <br>
                                            </p>
                                            <hr>
                                            <p class="text-center text-primary">Booking Details</p>
                                            <p class="mb-3 sm">
                                                ...
                                                User: <?php echo $services->user_name; ?> <br>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="card-footer text-center mb-3 sm">
                                        <a href="user_payments?delete=<?php echo $services->payment_id; ?>" class="badge badge-pill badge-danger">
                                            Delete
                                        </a>
                                    </div>
                                </div>
