...
if (isset($_GET['update_status'])) {
    ...
    if ($prepare) {
        ...
        header("Location: host_booking?view=$update_status");
        exit;
    } else {
                                ...
                                <div class="card card-round border border-success text-dark">
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        ?>
                                            <div class="carousel-item active">
                                                <img src="../public/services/<?php echo $services_images->file_data; ?> " class="d-block w-100 img-thumbnail img-fluid" alt="">
                                            </div>
                                        <?php } ?>
                                    </div>
                                    <hr>
                                    <div class="card-body">
                                        <div class="card-content">
                                            <p class="text-center text-primary"><b>Booking Details</b></p>
                                            <p class="mb-3 sm">
                                            ...
                                            <hr>
                                            <p class="text-center text-primary"><b>Service Details</b></p>
                                            <p class="mb-3 sm">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tag" viewBox="0 0 16 16">
                                                    <path d="M6 4.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm-1 0a.5.5 0 1 0-1 0 .5.5 0 0 0 1 0z" />
                                                    <path d="M2 1h4.586a1 1 0 0 1 .707.293l7 7a1 1 0 0 1 0 1.414l-4.586 4.586a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 1 6.586V2a1 1 0 0 1 1-1zm0 5.586 7 7L13.586 9l-7-7H2v4.586z" />
                                            ...
                                            <hr>
                                            <p class="text-center text-primary"><b>User Details</b></p>
                                            <p class="mb-3 sm">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-bounding-box" viewBox="0 0 16 16">
                                                    <path d="M1.5 1a.5.5 0 0 0-.5.5v3a.5.5 0 0 1-1 0v-3A1.5 1.5 0 0 1 1.5 0h3a.5.5 0 0 1 0 1h-3zM11 .5a.5.5 0 0 1 .5-.5h3A1.5 1.5 0 0 1 16 1.5v3a.5.5 0 0 1-1 0v-3a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 1-.5-.5zM.5 11a.5.5 0 0 1 .5.5v3a.5.5 0 0 0 .5.5h3a.5.5 0 0 1 0 1h-3A1.5 1.5 0 0 1 0 14.5v-3a.5.5 0 0 1 .5-.5zm15 0a.5.5 0 0 1 .5.5v3a1.5 1.5 0 0 1-1.5 1.5h-3a.5.5 0 0 1 0-1h3a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 1 .5-.5z" />
                                                    <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm8-9a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                                        ...
                                        <div class="card-footer text-center mb-3 sm">
                                            <?php if ($services->booking_status == 'Pending') { ?>
                                                <a href="host_booking?view=<?php echo $services->booking_id; ?>&update_status=<?php echo $services->booking_id; ?>&status=Approved" class="badge badge-pill badge-success">
                                                    Approve Booking
                                                </a>
                                            <?php } else { ?>
                                                <a href="host_payments" class="badge badge-pill badge-primary">
