                    ...
                    <div class="row">
                        <div class="col">
                            <h6 class="text-dark my-1 text-center">
                                ...
                                <span class="text-center vm ml-2">Hosts Reportsgit </span>
                            </h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <table id="report" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $services->host_name; ?></td>
                                    <td><?php echo $services->host_phone_no; ?></td>
                                    <td><?php echo $services->host_email; ?></td>
                                    <td><?php echo $services->host_address; ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
