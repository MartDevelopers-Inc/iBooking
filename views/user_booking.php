                    ...
                    <div class="row">
                        <div class="col">
                            <h6 class="text-dark my-1">
                                <span class="text-center vm ml-2">Service Booking Details</span>
                            </h6>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card card-round border border-success text-dark">
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        ?>
                                            <div class="carousel-item active">
                                                <img src="../public/services/<?php echo $services_images->file_data; ?> " class="img-fluid img-thumbnail d-block w-100" alt="">
                                            </div>
                                        <?php } ?>
                                    </div>
                                    <hr>
                                    <div class="card-body">
                                        ...
                                        <div class="card-footer text-center mb-3 sm">
                                            ...
                                            <?php } else { ?>
                                                <a href="user_booking_pay?view=<?php echo $services->booking_id; ?>&ref=<?php echo $services->booking_ref; ?>" class="badge badge-pill badge-primary">
                                                    Pay Booking
                                                </a>
                                            <?php } ?>
                                        </div>
