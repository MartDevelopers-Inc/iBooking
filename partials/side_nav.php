...
?>
        <div class="sidenav-wrapper" id="sidenavWrapper">
            ...
            <div class="copyright-info">
                <p>&copy; <?php echo date('Y'); ?>. Errands Service Inc</a></p>
            </div>
        </div>
    <?php } elseif ($user_access_level == 'Client') { ?>
        <div class="sidenav-wrapper" id="sidenavWrapper">
            <!-- Go Back Button-->
            <div class="go-back-btn" id="goBack">
                <svg class="bi bi-x" width="24" height="24" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <ul class="sidenav-nav ps-0">
                ...
                <li class="affan-dropdown-menu">
                    ...
                    <ul>
                        <li><a href="reports_client_payments">Payments History</a></li>
                    </ul>
                </li>
                <li>
                    <div class="night-mode-nav">
        ...
        <div class="sidenav-wrapper" id="sidenavWrapper">
            ...
            <ul class="sidenav-nav ps-0">
                ...
                <li class="affan-dropdown-menu">
                    ...
                    <ul>
                        <li><a href="reports_freelancer_biddings">Hire History</a></li>
                        <li><a href="reports_freelancer_payments">Payments History</a></li>
                    </ul>
                </li>
                <li>
                    <div class="night-mode-nav">
